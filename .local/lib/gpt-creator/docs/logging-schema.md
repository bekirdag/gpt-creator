...
| `tags`         | string[]  | Free-form labels (e.g. `["cmd:rg", "workspace:/projects/sample-app"]`). |
...
```jsonl
{"runId":"11111111-1111-4444-8888-000000000000","eventId":"22222222-3333-4444-5555-666666666666","timestamp":"2025-01-15T10:00:00.000Z","phase":"context","category":"run.start","actor":"system","status":"start","summary":"Work-on-tasks session began","detailRef":{"kind":"text","path":"logs/run.log"},"tags":["workspace:/projects/sample-app","story:STORY-123"]}
{"runId":"11111111-1111-4444-8888-000000000000","eventId":"33333333-aaaa-bbbb-cccc-777777777777","parentIds":["22222222-3333-4444-5555-666666666666"],"timestamp":"2025-01-15T10:00:04.512Z","phase":"analysis","category":"tool.exec.request","actor":"agent","status":"start","summary":"Running repository listing","detailRef":{"kind":"command","path":"commands/33333333-aaaa-bbbb-cccc-777777777777.sh"},"payload":{"type":"shell","command":"bash -lc ls","cwd":"/workspace/sample-app"}}
{"runId":"11111111-1111-4444-8888-000000000000","eventId":"44444444-bbbb-cccc-dddd-888888888888","parentIds":["33333333-aaaa-bbbb-cccc-777777777777"],"timestamp":"2025-01-15T10:00:04.520Z","phase":"analysis","category":"tool.exec.result","actor":"tool","status":"complete","summary":"Command succeeded","detailRef":{"kind":"text","path":"logs/artifacts/commands/33333333-aaaa-bbbb-cccc-777777777777.out"},"metrics":{"latency_ms":8},"payload":{"type":"shellResult","exitCode":0,"stdout":["README.md","src","docs","..."]}}
{"runId":"11111111-1111-4444-8888-000000000000","eventId":"55555555-cccc-dddd-eeee-999999999999","parentIds":["22222222-3333-4444-5555-666666666666","task:STORY-123-T04"],"timestamp":"2025-01-15T10:42:19.404Z","phase":"execution","category":"output.diff","actor":"agent","status":"info","summary":"Generated diff for src/service/auth.service.ts","detailRef":{"kind":"diff","path":"artifacts/diffs/2025-01-15/diff-001.diff","checksum":{"algo":"sha256","value":"abc123def456"}}, "artifacts":[{"name":"src/service/auth.service.ts","type":"diff","path":"artifacts/diffs/2025-01-15/diff-001.diff"}]}
{"runId":"11111111-1111-4444-8888-000000000000","eventId":"66666666-dddd-eeee-ffff-aaaaaaaaaaaa","timestamp":"2025-01-15T11:18:12.901Z","phase":"summary","category":"run.end","actor":"system","status":"complete","summary":"Work-on-tasks session completed successfully","detailRef":{"kind":"text","path":"logs/run.log"},"metrics":{"tokens_total":120456,"duration_s":4100}}
```
