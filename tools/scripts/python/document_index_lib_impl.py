...
def _apply_pruning(
    ...
    *,
    ...
    if segments and total_estimated <= 0:
        total_estimated = 1
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if len(args) < 8:
        raise SystemExit("Usage: document_index <db> <story_slug> <task_index> <prompt_path> <context_tail> <model> <project_root> <staging_dir>")
    DB_PATH, STORY_SLUG, TASK_INDEX, PROMPT_PATH, CONTEXT_TAIL_PATH, MODEL_NAME, PROJECT_ROOT, STAGING_DIR = args[:8]
